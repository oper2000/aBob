...
curl -X POST -H "Authorization: Basic YWRtaW46YWRtaW4=" -H "Cache-Control: no-cache" -H "Content-Type: multipart/form-data; boundary=----WebKitFormBoundary7MA4YWxkTrZu0gW" -F "appDescriptorAndroid.json=@$SCRIPT_DIR/appDescriptorAndroid.json" 'http://localhost:9080/mfpadmin/management-apis/2.0/runtimes/mfp/deploy?type=APP_DESCRIPTOR'